...
//수정
export const updateReceptiondApi = async (staffId: number | string, receptionReq: ReceptionUpdateRequest): Promise<ApiResponse<ReceptionResponse>> => {
...
//영구 삭제
export const deleteReceptionApi = async (staffId: number | string): Promise<ApiResponse<void>> => {
