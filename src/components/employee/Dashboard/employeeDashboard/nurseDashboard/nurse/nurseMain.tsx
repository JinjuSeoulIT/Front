...
import { deleteNurseRequest, nurselistRequest, resetCreateSuccess } from "@/features/employee/nurse/nurseSlice";
...
const NurseListPage = () => {
  ...
  const handleCreate = () => router.push("/staff/nurse/join/create");
  const handleDetail = (id: number) => router.push(`/staff/nurse/join/${id}/detail`);
  const handleEdit = (id: number) => router.push(`/staff/nurse/join/${id}/edit`);
