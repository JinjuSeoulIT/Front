...
const StaffOnboardingHub = ({ staffId, staffName }: Props) => {
  ...
  router.push(`/staff/employee/doctor/SignUp/${staffId}/create`);
};
  ...
  router.push(`/staff/employee/nurse/SignUp/${staffId}/create`);
};
