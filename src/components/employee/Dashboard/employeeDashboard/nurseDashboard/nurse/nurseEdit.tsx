...
import { initialNurseUpdateForm, NurseCreateRequest, NurseIdnNumber, NurseUpdateRequest } from "@/features/employee/nurse/nurseTypes";
import { createNurseRequest, DetailNurseRequest, resetCreateSuccess } from "@/features/employee/nurse/nurseSlice";
          ...
          <Stack spacing={2.5} component="form" onSubmit={handleSubmit}>
            ...
            <Stack spacing={2}>
              ...
              <Stack direction={{ xs: "column", sm: "row" }} spacing={1.25}>
                <Button
                  variant="outlined"
                  onClick={() => router.replace("/staff/nurse/join/list")}
                  disabled={loading}
                  fullWidth
                >
                  뒤로가기
