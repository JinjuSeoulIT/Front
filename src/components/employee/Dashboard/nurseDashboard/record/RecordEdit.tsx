...
export default function RecordEdit() {
  ...
  const { selected, loading, error } = useSelector((state: RootState) => state.records);
      ...
      <CardContent sx={{ p: 2.5 }}>
        ...
        <RecordForm
          ...
          onSubmit={(payload) => {
            ...
            router.push("/staff/employee/nurse/record/list");
          }}
          onCancel={() => router.push("/staff/employee/nurse/record/list")}
        />
      </CardContent>
    </Card>
  );
