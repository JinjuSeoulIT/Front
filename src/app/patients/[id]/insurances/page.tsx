...
export default function PatientInsurancesPage() {
  ...
  const [insuranceDialogMode, setInsuranceDialogMode] = React.useState<
    "create" | "edit"
  >("create");
  const [editingInsurance, setEditingInsurance] = React.useState<Insurance | null>(
    null
  );
  ...
  const onSubmitInsurance = () => {
    ...
    dispatch(
      insuranceActions.updateInsuranceRequest({
        ...
        form: {
          insuranceType:
            insuranceForm.insuranceType || editingInsurance.insuranceType,
          policyNo: toOptional(insuranceForm.policyNo),
                ...
                <TableRow key={item.insuranceId} hover>
                  ...
                  <TableCell>
                    <Stack direction="row" spacing={0.5}>
                      <IconButton
                        size="small"
                        onClick={() => openEditInsurance(item)}
                      >
